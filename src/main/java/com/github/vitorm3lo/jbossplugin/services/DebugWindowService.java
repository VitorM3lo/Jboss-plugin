...
public class DebugWindowService {
    ...
    public static void attach(Project project, RemoteConnection con, String serverName) {
        RunnerAndConfigurationSettings runSettings =
                RunManager.getInstance(project).createConfiguration(serverName, ProcessAttachRunConfigurationType.FACTORY);
